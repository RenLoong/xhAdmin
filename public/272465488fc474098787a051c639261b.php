<?php /*a:4:{s:84:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/User/integral.html";i:1729154177;s:83:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/modules/main.html";i:1729137598;s:85:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/modules/header.html";i:1729154253;s:83:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/modules/menu.html";i:1728979414;}*/ ?>
<!DOCTYPE html>
...
<div class="p-4 flex flex-center">
    <div class="flex flex-center record-create-header app-init-none">
        <el-radio-group v-model="search.action" size="large" :disabled="!USERINFO"
        @change="searchList">
            <el-radio-button value="all">
                <span class="h8 font-weight-600">全部</span>
                <span class="h10 text-info">包括获取，消耗明细</span>
            </el-radio-button>
            <el-radio-button value="increase">
                <span class="h8 font-weight-600">获取</span>
                <span class="h10 text-info">通过充值，开通会员，兑换等渠道获取的<?php echo htmlentities($system['money_name']); ?></span>
            </el-radio-button>
            <el-radio-button value="decrease">
                <span class="h8 font-weight-600">消耗</span>
                <span class="h10 text-info">复刻数字人，克隆语音，创作视频等场景消耗</span>
            </el-radio-button>
        </el-radio-group>
    </div>
</div>
...
<div class="p-4">
    <div class="bg-white p-10 rounded-4">
        <el-table :data="list" style="width: 100%;margin: 0 auto;" size="large">
            <el-table-column label="内容">
                <template #default="scope">
                    <div class="flex flex-column grid-gap-2">
                        <span class="h8 font-weight-500">{{scope.row.remarks}}</span>
                        <span class="h10">{{scope.row.create_time}}</span>
                    </div>
                </template>
            </el-table-column>
            <el-table-column label="<?php echo htmlentities($system['money_name']); ?>" width="300">
                <template #default="scope">
                    <div class="h6 font-weight-600">
                        <span v-if="scope.row.action==='increase'" class="text-warning">+{{scope.row.integral}}</span>
                        <span v-else class="text-success">-{{scope.row.integral}}</span>
                    </div>
                </template>
            </el-table-column>
          </el-table>
...
<script src="/app/ycDigitalHuman//pc/User/integral.js"></script>
