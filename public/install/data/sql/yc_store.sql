...
CREATE TABLE `yc_store`  (
  ...
  `status` enum('10','20') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '使用状态：10冻结，20正常',
  ...
  `other` int(11) NOT NULL DEFAULT 0 COMMENT '其他应用',
