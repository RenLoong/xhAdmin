...
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '租户-菜单' ROW_FORMAT = DYNAMIC;

INSERT INTO `yc_store_menus` VALUES (1, '2022-10-27 17:22:51', '2023-07-24 14:15:06', 'store', 'Index/index', '\\app\\store\\controller\\', 0, '首页', 0, '[\"GET\"]', '10', 'remote/index', '/remote/store/index', 'HomeOutlined', '20', '20', '20');
INSERT INTO `yc_store_menus` VALUES (2, '2022-10-27 17:22:51', '2023-07-24 14:14:16', 'store', 'Index/welcome', '\\app\\store\\controller\\', 1, '控制台', 0, '[\"GET\"]', '10', 'remote/index', '/remote/store/index', '', '10', '20', '20');
...
INSERT INTO `yc_store_menus` VALUES (18, '2023-05-03 16:57:25', '2023-05-03 17:06:25', 'store', '', '\\app\\store\\controller\\', 0, '平台', 0, '[\"GET\"]', '10', 'none/index', '', 'ShopOutlined', '10', '10', '10');
INSERT INTO `yc_store_menus` VALUES (19, '2023-05-03 17:05:10', '2023-07-24 23:59:43', 'store', 'Index/test1', '\\app\\store\\controller\\', 0, '测试方法', 0, '[\"GET\",\"POST\"]', '20', 'form/index', '', 'UserOutlined', '10', '10', '10');
INSERT INTO `yc_store_menus` VALUES (20, '2023-05-03 17:08:07', '2023-07-24 14:45:43', 'store', 'StoreApp/applet', '\\app\\store\\controller\\', 21, '小程序配置', 0, '[\"GET\",\"PUT\",\"POST\"]', '20', 'remote/index', 'remote/store/applet', 'SettingTwotone', '10', '10', '10');
INSERT INTO `yc_store_menus` VALUES (21, '2023-05-03 17:11:21', '2023-07-23 15:19:34', 'store', 'StoreApp/index', '\\app\\store\\controller\\', 18, '项目管理', 0, '[\"GET\"]', '20', 'table/index', '', '', '10', '10', '10');
INSERT INTO `yc_store_menus` VALUES (22, '2023-05-03 17:11:55', '2023-07-23 15:24:18', 'store', 'StoreApp/create', '\\app\\store\\controller\\', 21, '创建项目', 0, '[\"GET\",\"POST\"]', '20', 'form/index', '', '', '10', '10', '10');
INSERT INTO `yc_store_menus` VALUES (23, '2023-05-03 17:13:06', '2023-07-22 20:26:22', 'store', 'Users/index', '\\app\\store\\controller\\', 0, '用户管理', 0, '[\"GET\"]', '20', 'table/index', '', 'UserOutlined', '20', '10', '10');
INSERT INTO `yc_store_menus` VALUES (24, '2023-05-03 17:13:59', '2023-07-23 15:25:13', 'store', 'StoreApp/config', '\\app\\store\\controller\\', 21, '项目设置', 0, '[\"GET\",\"PUT\"]', '20', 'form/index', '', '', '10', '10', '10');
...
INSERT INTO `yc_store_menus` VALUES (26, '2023-05-03 17:39:14', '2023-07-23 15:25:36', 'store', 'Users/edit', '\\app\\store\\controller\\', 23, '修改用户', 0, '[\"GET\",\"PUT\"]', '20', 'form/index', '', '', '10', '10', '10');
...
INSERT INTO `yc_store_menus` VALUES (31, '2023-05-03 19:53:40', '2023-07-23 16:11:28', 'store', 'StoreApp/edit', '\\app\\store\\controller\\', 21, '修改项目', 0, '[\"GET\",\"PUT\"]', '20', 'form/index', '', '', '10', '10', '10');
INSERT INTO `yc_store_menus` VALUES (32, '2023-06-16 11:44:08', '2023-07-23 15:27:31', 'store', 'StoreApp/del', '\\app\\store\\controller\\', 21, '删除项目', 0, '[\"GET\",\"DELETE\"]', '20', 'none/index', '', '', '10', '10', '10');
