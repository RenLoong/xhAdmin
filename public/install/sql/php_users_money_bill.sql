...
-- ----------------------------
-- Table structure for php_users_money_bill
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户-余额账单' ROW_FORMAT = DYNAMIC;
