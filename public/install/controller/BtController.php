    ...
    public function install()
    {
        ...
        switch ($step) {
            ...
            case 'database':
                ...
                try {
                    # 写入站点名称
                    $sql = "INSERT INTO `{$database['prefix']}system_config` VALUES (1, '2023-07-06 11:01:59', '2023-07-20 11:32:50', 'web_name', '{$site['web_name']}', NULL, NULL);";
                    # 执行SQL
                    Db::exceSQL($sql);
                    # 写入站点域名
                    $sql = "INSERT INTO `{$database['prefix']}system_config` VALUES (2, '2023-07-06 11:01:59', '2023-07-06 11:01:59', 'web_url', '{$site['web_url']}', NULL, NULL);";
                    # 执行SQL
                    Db::exceSQL($sql);
                    # 获取管理员参数
