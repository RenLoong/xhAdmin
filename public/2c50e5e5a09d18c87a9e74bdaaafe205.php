<?php /*a:4:{s:76:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/index.html";i:1728704829;s:83:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/modules/main.html";i:1728706115;s:85:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/modules/header.html";i:1728716130;s:83:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/modules/menu.html";i:1728716469;}*/ ?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="flex flex-center grid-gap-2 app-init-none rounded-round bg-login-box px-4 py-2" v-if="USERINFO">
    ...
    <div class="px-6 py-2 app-init-none" v-else>
        <el-popover placement="bottom-end" :width="260" trigger="click" popper-class="userinfo-popover">
            <template #reference>
    ...
    <ul class="flex flex-column grid-gap-1" id="menu">
        <li class="<?php if(request()->controller().'-'.request()->action() == 'Index-index'): ?>active<?php endif; ?>">
        ...
        <div class="grid-column-4 p-2 block-item rounded-4 flex flex-column">
            <div class="flex-1 border rounded-4 border-primary flex flex-column p-6 border-dashed flex-y-flex-start grid-gap-4 pointer">
                ...
                <div class="rounded-round bg-active text-white px-4 py-2 flex">
                    <span>快速复刻</span>
                    <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
                        <path fill="var(--el-bg-color)" d="M761.056 532.128c0.512-0.992 1.344-1.824 1.792-2.848 8.8-18.304 5.92-40.704-9.664-55.424L399.936 139.744c-19.264-18.208-49.632-17.344-67.872 1.888-18.208 19.264-17.376 49.632 1.888 67.872l316.96 299.84L335.2 813.632c-19.072 18.4-19.648 48.768-1.248 67.872 9.408 9.792 21.984 14.688 34.56 14.688 12 0 24-4.48 33.312-13.44l350.048-337.376c0.672-0.672 0.928-1.6 1.6-2.304 0.512-0.48 1.056-0.832 1.568-1.344 2.72-2.848 4.16-6.336 6.016-9.6z"></path>
                    </svg>
                </div>
                <div class="flex-1"></div>
            </div>
        </div>
        <div class="grid-column-4 p-2 block-item rounded-4">
            <div class="rounded-4 flex flex-column flex-y-flex-start grid-gap-4">
                <div class="block-image-bg w-100 rounded-4" style="--img:url('https://saas.kf.renloong.com/uploads/system_upload/20240902/3f8263a88301fcdc63ccf08421889a9b.png');">
                    <div class="block-image rounded-4 text-center">
                        <img src="https://saas.kf.renloong.com/uploads/system_upload/20240902/3f8263a88301fcdc63ccf08421889a9b.png" alt="客服" style="max-width: 100%;height: max(10vw,170px);">
                    </div>
                </div>
                <div class="text-ellipsis-2 w-100 text-break-all">dwadawddwadawddwadawd</div>
            </div>
        </div>
        <div class="grid-column-4 p-2 block-item rounded-4">
            <div class="rounded-4 flex flex-column flex-y-flex-start grid-gap-4">
