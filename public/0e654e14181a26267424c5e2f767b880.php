<?php /*a:4:{s:83:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/Record/index.html";i:1729074403;s:83:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/modules/main.html";i:1729220769;s:85:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/modules/header.html";i:1729232021;s:83:"/www/wwwroot/saas.kf.renloong.com/plugin/ycDigitalHuman/public/pc/modules/menu.html";i:1728979414;}*/ ?>
<!DOCTYPE html>
...
<div class="p-4 flex flex-column">
    <div class="title-bolck flex flex-y-center">
        <span class="title-bolck-text">我的作品</span>
    </div>
    <div class="grid grid-columns-20 grid-gap-4 py-4">
        <div class="grid-column-4 p-2 block-item rounded-4 flex flex-column">
            <div class="flex-1 border rounded-4 border-primary flex flex-column p-6 border-dashed flex-y-flex-start grid-gap-4 pointer"
                @click="usage.createVideo()">
                <div class="flex-1"></div>
                <span class="h1 font-weight-600">视频创作</span>
                <span class="mb-2 text-info">通过文字或语音驱动数字人分身</span>
                <div class="flex-1"></div>
        ...
        <div class="grid-column-4 p-2 block-item rounded-4 app-init-none" v-for="(item,index) in list">
            <div class="rounded-4 flex flex-column flex-y-flex-start grid-gap-4">
                <div class="block-image-bg w-100 rounded-4"
                    :style="[item.image?'--img:url('+item.image+')':'--img:var(--login-box-bg)']"
                    @click="video.play(item.video_url)">
                    <div class="block-image rounded-4 text-center">
                        <img v-if="item.image" :src="item.image" style="max-width: 100%;height: max(10vw,170px);">
                        <img v-else src="/app/ycDigitalHuman//image/default-scene.png"
                            style="max-width: 100%;height: max(10vw,170px);">
                    </div>
                    <div class="app-init-none">
                        <div class="play-icon" v-if="item.state === 1&&item.video_url"></div>
                        <div class="progress-mask flex flex-column flex-center rounded-4 grid-gap-4"
                            v-if="item.state === 0">
                            ...
                            <span class="text-primary h10">视频生成中...</span>
                        ...
                        <div class="progress-mask flex flex-column flex-center rounded-4" v-else-if="item.state === 99">
                            <div class="flex flex-column flex-center grid-gap-2">
                                ...
                                <div class="flex grid-gap-2">
                                    ...
                                    <span class="h10 py-2 px-4 bg-primary rounded-4 text-white"
                                        @click.stop="retry(item)">重试</span>
                                </div>
                            </div>
                        </div>
                        <div class="down-icon rounded-2" @click.stop="video.download(item.download_video_url)"
                            v-if="item.state===1">
                            <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20"
                                height="20">
                                <path fill="var(--el-text-color-primary)"
                                    d="M919.724075 715.073068c-1.140986-27.353998-19.024286-42.460044-42.618657-41.899272-23.378453 0.554632-38.799678 15.928784-40.99467 43.88858-1.610684 20.539802-0.231267 41.299615-0.676405 61.951981-1.115404 51.828412-12.339026 63.804165-64.151066 64.826448-49.90869 0.985444-99.853196 0.323365-149.781328 0.327458-115.351168 0.00921-230.704382 0.094144-346.05555-0.065492-79.440283-0.109494-86.325088-6.972808-86.704734-84.203774-0.068562-13.770632 0.62524-27.626197-0.639566-41.293475-2.692319-29.087479-16.327874-44.221154-39.414685-45.526893-24.920576-1.411139-43.084261 15.533788-44.989657 45.49517-1.74269 27.442002-0.763386 55.07127-0.582261 82.615603 0.590448 89.169879 40.095183 129.182174 129.293715 129.691781 92.966345 0.532119 185.938829 0.118704 278.909268 0.140193 27.54638 0.022513 55.094806 0.031722 82.640162 0.021489 70.589708-0.024559 141.195789 0.956791 211.758891-0.39295 62.212924-1.189082 107.706047-37.176714 112.958678-91.756797C922.616962 797.940404 921.441183 756.292865 919.724075 715.073068z">
                                </path>
                                <path fill="var(--el-text-color-primary)"
                                    d="M197.8583 440.865893c88.756463 88.806605 177.525206 177.601954 266.292925 266.398326 3.647063 3.64911 7.361665 7.230682 10.984169 10.902304 14.284331 14.481829 30.947849 22.644743 51.134611 14.996552 6.584975-2.494821 11.479449-6.255471 15.664771-10.522658 2.762927-1.912559 5.470595-4.0175 7.9296-6.407943 45.635363-44.375673 240.102427-239.467977 285.027615-284.574291 4.825912-4.845355 9.463536-10.05296 13.269211-15.71082 12.214183-18.164708 10.541077-35.95898-3.945869-51.853995-14.818497-16.257266-33.480532-16.939811-51.874461-7.894807-8.930393 4.391007-16.285918 12.4608-23.556509 19.673062-30.239721 29.991058-139.611711 139.26481-212.845643 212.610282 0.037862-114.560152 0.050142-229.119281 0.027629-343.680457-0.00614-34.398438 1.090844-68.859297-0.615007-103.175871-1.587148-31.878035-17.058514-48.140417-41.968857-48.957015-25.551956-0.838088-41.055045 14.728446-44.538379 46.158273-1.320065 11.908214-0.623193 24.053835-0.629333 36.09201-0.040932 75.676563-0.021489 151.355173-0.021489 227.033783-0.001023 56.590879 0 113.181759 0 169.773661-3.928472 1.738597-7.855922 3.476171-11.784394 5.214768-22.74912-22.663162-45.525869-45.303812-68.245314-67.99665-47.452755-47.405683-94.28948-95.445816-142.575206-141.985782-21.800515-21.013593-47.071062-21.358447-64.429405-4.840238-18.709107 17.803481-18.050098 39.000246 2.325975 63.951521C187.818643 431.374728 192.996572 436.000072 197.8583 440.865893z">
                                </path>
                            </svg>
                        </div>
                ...
                <div class="w-100 flex flex-center grid-gap-4">
                    ...
                    <div class="flex flex-center flex-shrink-0 grid-gap-2 rounded-round bg-active text-white px-4 py-2 create-video"
                        v-if="item.state === 1"
                        @click="usage.createVideo({sceneid:item.sceneid,voiceid:item.voiceid,voice_action:item.voice_action})">
                        <span class="h10">立即创作</span>
...
<script src="/app/ycDigitalHuman//pc/Record/index.js"></script>
