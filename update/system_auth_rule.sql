...
UPDATE `yc_system_auth_rule` SET `show` = '1' WHERE `path` = 'Modules/tabs';
UPDATE `yc_system_auth_rule` SET `show` = '1' WHERE `path` = 'Modules/index';
UPDATE `yc_system_auth_rule` SET `show` = '0' WHERE `path` = 'Modules/add';
UPDATE `yc_system_auth_rule` SET `show` = '0' WHERE `path` = 'Modules/edit';
UPDATE `yc_system_auth_rule` SET `show` = '0' WHERE `path` = 'Modules/del';
UPDATE `yc_system_auth_rule` SET `show` = '0' WHERE `path` = 'Modules/indexGetTable';
UPDATE `yc_system_auth_rule` SET `show` = '0' WHERE `path` = 'Fields/index';
UPDATE `yc_system_auth_rule` SET `show` = '0' WHERE `path` = 'Fields/add';
UPDATE `yc_system_auth_rule` SET `show` = '0' WHERE `path` = 'Fields/edit';
UPDATE `yc_system_auth_rule` SET `show` = '0' WHERE `path` = 'Fields/del';
UPDATE `yc_system_auth_rule` SET `show` = '0' WHERE `path` = 'Fields/indexGetTable';
